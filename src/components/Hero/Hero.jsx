  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#915eff]">Gideon</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>I am a Full Stack Web &<br className="sm:block hidden" /> Mobile applications developer</p>
        </div>
      </div>
      {/* <Computers /> */}
      <div className="absolute top-[40%] left-1/2 transform -translate-x-1/2 w-full max-w-6xl h-[60vh] bg-black rounded-2xl overflow-hidden">
        <video ref={videoRef} src={progVid} loop muted className="w-full h-full object-cover">
